...
namespace ShiftDrive {
    ...
    internal sealed class ConsoleHelm : Console {
        ...
        public override void Draw(GraphicsDevice graphicsDevice, SpriteBatch spriteBatch) {
            ...
            spriteBatch.Draw(Assets.txFillbar, new Rectangle(40, throttleBarY + throttleFillY, 64, throttleFillH), new Rectangle(64, throttleFillY, 64, throttleFillH), Color.White);
            // bar outline
            spriteBatch.Draw(Assets.txFillbar, new Rectangle(40, throttleBarY, 64, 24), new Rectangle(0, 0, 64, 24), Color.White);
            spriteBatch.Draw(Assets.txFillbar, new Rectangle(40, throttleBarY + baseBarHeight - 24, 64, 24), new Rectangle(0, 24, 64, 24), Color.White);
