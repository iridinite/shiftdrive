...
namespace ShiftDrive {
    ...
    internal class FormOptions : IForm {
        ...
        public FormOptions() {
            ...
            btn2 = new TextButton(1, -1, SDGame.Inst.GameHeight / 2 - 55, 250, 40, Utils.LocaleGet("option_2"));
            btn3 = new TextButton(2, -1, SDGame.Inst.GameHeight / 2 - 10, 250, 40, Utils.LocaleGet("option_3"));
            btn4 = new TextButton(3, -1, SDGame.Inst.GameHeight / 2 + 35, 250, 40, Utils.LocaleGet("option_4"));
            btn5 = new TextButton(4, -1, SDGame.Inst.GameHeight / 2 + 80, 250, 40, Utils.LocaleGet("option_5"));
            btn6 = new TextButton(5, -1, SDGame.Inst.GameHeight / 2 + 125, 250, 40, Utils.LocaleGet("option_6"));
            btnCancel = new TextButton(6, -1, SDGame.Inst.GameHeight / 2 + 210, 250, 40, Utils.LocaleGet("cancel"));
